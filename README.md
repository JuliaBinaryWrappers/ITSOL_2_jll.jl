# `ITSOL_2_jll.jl` (v0.1.2+0)

[![deps](https://juliahub.com/docs/ITSOL_2_jll/deps.svg)](https://juliahub.com/ui/Packages/ITSOL_2_jll/KnXDZ?page=2)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/006564b44dc4edb81d1815397481f4a8b7b69b1b/I/ITSOL_2/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `ITSOL_2_jll.jl` have been built from these sources:

* git repository: https://github.com/JuhaHeiskala/itsol_mod.git (revision: `36319fcb6d154d664e3c27c0eac04867962979e3`)

## Platforms

`ITSOL_2_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `ITSOL_2_jll.jl`:
